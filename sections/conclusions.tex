...
\begin{itemize}
    \item \textbf{Observabilidad}: endpoint \texttt{/metrics} con conteo de requests y latencia (formato Prometheus).
    \item \textbf{Frontend containerizado}: la aplicaci\'on Angular servida desde Nginx como segunda imagen Docker.
    \item \textbf{Docker Compose}: orquestaci\'on local de backend + frontend con un solo \texttt{docker compose up}.
